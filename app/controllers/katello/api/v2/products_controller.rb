module Katello
  class Api::V2::ProductsController < Api::V2::ApiController
    ...
    def authorize_gpg_key
      ...
      if gpg_key_id
        gpg_key = ContentCredentials.readable.where(:id => gpg_key_id, :organization_id => @organization).first
    ...
    def authorize_ssl_ca_cert
      ...
      if ssl_ca_cert_id
        ssl_ca_cert = ContentCredentials.readable.where(:id => ssl_ca_cert_id, :organization_id => @organization).first
    ...
    def authorize_ssl_client_cert
      ...
      if ssl_client_cert_id
        ssl_client_cert = ContentCredentials.readable.where(:id => ssl_client_cert_id, :organization_id => @organization).first
    ...
    def authorize_ssl_client_key
      ...
      if ssl_client_key_id
        ssl_client_key = ContentCredentials.readable.where(:id => ssl_client_key_id, :organization_id => @organization).first
