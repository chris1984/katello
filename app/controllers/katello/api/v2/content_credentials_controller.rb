module Katello
  class Api::V2::ContentCredentialsController < Api::V2::ApiController
    ...
    def index_relation
      query = ContentCredentials.readable.where(:organization_id => @organization.id)
    ...
    def update
      sync_task(::Actions::Katello::ContentCredentials::Update, @content_credential, content_credential_params.to_h)
      respond_for_show(:resource => @content_credential)
    end
