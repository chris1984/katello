module Katello
  class Product < Katello::Model
    ...
    belongs_to :gpg_key, :inverse_of => :products, :class_name => "Katello::ContentCredentials"
    ...
    belongs_to :ssl_ca_cert, :class_name => "Katello::ContentCredentials", :inverse_of => :ssl_ca_products
    belongs_to :ssl_client_cert, :class_name => "Katello::ContentCredentials", :inverse_of => :ssl_client_products
    belongs_to :ssl_client_key, :class_name => "Katello::ContentCredentials", :inverse_of => :ssl_key_products
