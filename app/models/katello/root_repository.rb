module Katello
  class RootRepository < Katello::Model
    ...
    belongs_to :gpg_key, :inverse_of => :root_repositories, :class_name => "Katello::ContentCredentials"
    belongs_to :ssl_ca_cert, :class_name => "Katello::ContentCredentials", :inverse_of => :ssl_ca_root_repos
    belongs_to :ssl_client_cert, :class_name => "Katello::ContentCredentials", :inverse_of => :ssl_client_root_repos
    belongs_to :ssl_client_key, :class_name => "Katello::ContentCredentials", :inverse_of => :ssl_key_root_repos
